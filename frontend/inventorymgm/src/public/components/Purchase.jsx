...
const Purchase = () => {
  return (
    <>
    <Navbar />
    <div className= 'mt-20  bg-[#f6f8fb] pb-7 h-[100vh] lg:mt-36'  >
<div className=' flex justify-center pt-6  mt-[-12px]'><CiFaceFrown className=' text-[39px] text-gray-400'/></div>
<div className=' text-center mt-10 text-[26px] font-bold'>No purchases found</div>
