...
const Categoriesproductitems = () => {
    ...
    return (
        <>
            ...
            <div className='w-full flex justify-center mt-12  lg:mt-[120px] pt-5 allorders bg-[#f6f8fb]'>
...
<Dropdown
      ...
      >
        <Button className=' opacity-[0.85]'><BsThreeDotsVertical /></Button>
                            ...
                            <div className=' hover:bg-gray-300 px-2'><Link to={'/setting/categories'}>X</Link> </div>
                        </div>
                    </div>
                                ...
                                <table className="w-full border-[2px] bg-white  border-gray-300">
                                    <thead>
                                        <tr className="bg-gray-300 text-blue-600 leading-10">
                                            ...
                                            <th className="px-4 py-2 border-[1px] border-gray-400 lg:w-[170px]">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
...
export default Categoriesproductitems;
