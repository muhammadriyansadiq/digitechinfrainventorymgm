...
const Suppliersidedit = () => {
  return (
    <>
      <Navbar />
      <form className=" pt-5 bg-[#f6f8fb] mt-16 lg:mt-32">
                  ...
                  <div className=" border-t-[1px] flex justify-center mt-3">
                    <div className=" w-full px-4 ">
                      <div className="  flex justify-center lg:justify-end mt-5">
                          ...
                          <button className=" bg-green-500 text-white font-semibold py-3 px-5 rounded-md hover:text-black hover:bg-green-400">
                            Save
                          </button>
...
export default Suppliersidedit;
