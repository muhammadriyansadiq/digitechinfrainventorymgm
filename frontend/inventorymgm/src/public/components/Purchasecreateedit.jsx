...
const Purchasecreateedit = () => {
  ...
  return (
    <>
      ...
      <div className=" bg-[#F6F8FB]  w-full flex justify-center py-3 orderscreate lg:mt-32">
          ...
          <div className=" lg:w-full border-[1px] bg-white ">
            <div className=" w-full flex justify-center  border-b-[1px] py-4">
              <div className=" flex justify-between w-11/12">
                ...
                <Link to={'/purchase/create'}>X</Link>
              </div>
            </div>
                ...
                <table className="w-full">
                  <thead className=" border-[1px]">
                    <tr className=" leading-8">
                      ...
                      <th className=" border-[1px] text-gray-600 text-[12px] w-[190px]">Price </th>
                      <th className=" border-[1px] text-gray-600 text-[12px] ">Subtotal</th>
                      <th className=" border-[1px] text-gray-600 text-[12px] w-[190px]">Action</th>
                    </tr>
                  </thead>
                  <tbody>
...
{display?
  ...
  <option value="audi">Audi</option>
                        ...
                        <td colSpan="" className=" py-2 border-[1px] text-center">
                            <input onChange={(e)=>setquantity(e.target.value)} value={quantity} type="number" name="" id="" className=" border-[1px] w-11/12" />
                            </td>
                        <td colSpan="" className="  py-2 border-[1px] text-center">
                            {price}
                        </td>
                        <td colSpan="" className=" border-[1px] text-center ">{price* quantity}</td>
                        <td className=" lg:w-[130px] border-[1px] text-center ">
                          <Link className="">
                            <div className="w-[100px]  flex justify-around lg:justify-center lg:w-full">
                              <button  onClick={datasend} className=" bg-green-500 p-2 text-white border-green-500 border-[1px] rounded-md hover:bg-white hover:text-green-500 lg:mr-2" >
            ...
            <div className=" w-full flex justify-center mt-8  border-[1px] py-4">
              <div className=" flex justify-end w-11/12">
                <div><button className=" bg-green-500 text-white px-4 py-2 rounded-md border-green-500 border-[1px] hover:bg-white hover:text-green-500">PurchaseEdit</button></div>
              </div>
            </div>
          </div>
        </div>
...
export default Purchasecreateedit;
