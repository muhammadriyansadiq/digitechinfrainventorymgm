...
const Unitsproductsedit = () => {
    ...
    return (
        <>
            ...
            <div className='w-full flex justify-center mt-16 pt-5 allorders bg-[#f6f8fb] lg:mt-32'>
                <div className='w-10/12 mt-2 border-[2px] rounded-md mb-3 bg-white'>
                    <div className='flex justify-between p-5 border-b-[1px] '>
                        <div className='font-sans font-medium text-gray-700 text-[21px]'>Edit Unit</div>
                    ...
                    <div className='p-5  w-full '>
                        <div className=' text-right'>
                            <button className=' bg-blue-600 py-2 border-[2px] font-semibold border-blue-500 hover:bg-white hover:text-blue-500 px-5 text-white rounded-md '>Update</button>
                        </div>
                    </div>
...
export default Unitsproductsedit;
