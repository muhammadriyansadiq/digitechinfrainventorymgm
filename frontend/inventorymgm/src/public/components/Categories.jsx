...
const Categories = () => {
    ...
    return (
        <>
            ...
            <div className='w-full mt-12 flex justify-center lg:mt-[120px] pt-5 allorders bg-[#f6f8fb]'>
                <div className='w-10/12 mt-2 border-[2px] rounded-md mb-3 bg-white'>
                    <div className='flex justify-between p-5 border-b-[1px] '>
                        ...
                        <Link to={'/setting/categories/create'}>
                                ...
                                <table className="w-full border-[2px] bg-white  border-gray-300">
                                    <thead>
                                        <tr className="bg-gray-300 text-blue-600 leading-10">
                                            ...
                                            <th className="px-4 py-2 border-[1px] border-gray-400">Products count</th>

                                            <th className="px-4 py-2 border-[1px] border-gray-400">Created At</th>
                                            <th className="px-4 py-2 border-[1px] border-gray-400 w-[120px]">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                            ...
                                            <tr key={index} className="border border-gray-300">
                                                ...
                                                <td className="px-4 py-2 border border-gray-300">
                                                    <div className='flex justify-around'>
                                                        <Link to={'/setting/categories/product'} className="bg-white border-[1px] border-blue-500 text-[19px] p-2 text-blue-500 hover:bg-blue-500 hover:text-white mr-2"><GoEye /></Link>
                                                        <Link to={'/setting/categories/product/edit'} className="bg-white border-[1px] border-orange-500 text-[19px] p-2 text-orange-500 hover:bg-orange-500 hover:text-white mr-2"><IoIosPrint /></Link>
