...
const Suppliersid = () => {
  return (
    <>
        <Navbar />
        <div className=' pt-5 mt-12 bg-[#f6f8fb] lg:mt-28' >
            ...
            <div className=' w-full flex justify-center my-4'>
                ...
                <Link to={'/pages/suppliers'} className=' text-blue-600'>Suppliers</Link>
                <p>< FaGreaterThan className=' text-blue-600 text-[14px]'/></p>
                <Link to={"/pages/suppliers/id"} className=' text-blue-600'>id</Link>
                </div>
                </div>
            </div>
...
<div className=' font-semibold text-[19px]'>Suppliers Details</div>
...
<div className=' my-5'>
  ...
  <div className=' w-full flex'>
    <div className=' border-[1px] w-3/12 pl-7 py-4'>Shop name	</div>
    <div className=' border-[1px] w-9/12 pl-7 py-4'>Bachat Mart
    </div>
  </div>
  <div className=' w-full flex'>
    <div className=' border-[1px] w-3/12 pl-7 py-4'>Type</div>
  ...
  <div className=' flex justify-end mt-7'>
    ...
    <Link to={'/pages/suppliers'} className=' bg-blue-500 px-4 py-2 flex items-center justify-between text-white border-[1px] border-blue-500 hover:bg-white hover:text-blue-500'><span className=' mr-2'><IoIosArrowRoundBack className=' text-[22px] ' /></span><span> Back</span></Link>
    <Link to={'/pages/suppliers/id/edit'} className=' bg-red-500  px-4 py-2 flex justify-between items-center text-white border-[1px] border-red-500 hover:bg-white hover:text-red-500 '><span className=' mr-2'><CiEdit className=' text-[22px]'/></span><span> Edit</span></Link>
    </div>
  </div>
