...
const Orderspending = () => {
    ...
    return (
        <>
            ...
            <div className='w-full flex justify-center mt-[140px] allorders'>
                <div className='w-10/12 border-[2px] rounded-md mb-3'>
                    <div className='flex justify-between p-5 border-b-[1px]'>
                        <div className='font-sans font-medium text-gray-700 text-[18px]'>Orders: pending</div>
                        <Link to={'/createorder'}>
                        ...
                        <div className="w-full flex justify-center px-4">
                            <div className="w-full  h-[300px] overflow-auto mt-5">
                                <table className="w-full border-[2px] bg-white  border-gray-300">
                                    <thead>
                                        <tr className="bg-gray-300 text-blue-600 leading-10 border-gray-500 border-[2px]">
